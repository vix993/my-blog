...
export const SiteView = ({ currentSite }) => {
  return (
    <a className="w-3/12 h-80 mx-auto rounded-2xl mt-4 cursor-pointer transition hover:opacity-80 hover:brightness-70 duration-150 hover:text-gray-700" href={currentSite.url}>
      <div className="w-full h-full rounded-2xl">
        ...
        <footer className="bg-yellow-100 rounded-b-lg flex gap-2 p-2 justify-center items-center">
          <a className="hover:text-yellow-500 flex items-center justify-center" href={currentSite.url} target="_blank">
            <Icon component={OpenInNewIcon}/>
          </a>
          <a className="hover:text-yellow-500 flex items-center justify-center" href={currentSite.github} target="_blank">
